  ...
  modelLinks.forEach((url, index) => {
    switch ($("#type").val()) {
      ...
      case "video":
        ...
        preview.append(
          previewTemplateForUpdate(url, index, "video", "old", "controls")
        );
        break;
      case "pdf":
      ...
      case "audio":
        ...
        preview.append(
          previewTemplateForUpdate(url, index, "audio", "old", "controls")
        );
        break;
      default:
        fileInput.attr("disabled", true);
  ...
  fileInput.off("change").on("change", function (event) {
    ...
    Array.from(files).forEach((file, index) => {
      ...
      switch ($("#type").val()) {
        case "audio":
          preview.append(
            previewTemplateForUpdate(url, index, "audio", "new", "controls")
          );
          break;
        case "video":
          preview.append(
            previewTemplateForUpdate(url, index, "video", "new", "controls")
          );
          break;
        case "photo":
