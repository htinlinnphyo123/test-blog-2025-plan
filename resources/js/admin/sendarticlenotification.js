...
$(document).ready(function(){
    $(".btnSentArticleNoti").click(function(){
        let optionsHtml = `
    ...
    `;
        Swal.fire({
            title: 'Select a Country to send Article',
            html: `
        ...
        `,
            ...
            if (result.isConfirmed) {
                ...
                const url = `/send-articlenoti/${articleID}`;
                ...
                axios.post(url, {
                    ...
                    .catch((error) => {
                        ...
                        Swal.fire('Error', 'There was an error sending the article.', 'error');
