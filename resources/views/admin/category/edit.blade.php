    ...
    <x-form.layout>
        <form action="{{ route('categories.update', $data['id']) }}" method="post">
            ...
            <x-form.grid>
                ...
                <x-form.input_group title="category.category_name_other" name="name_other" id="name_other" :value="$data['name_other']" :required="true" placeholder="category_name_other"/>
